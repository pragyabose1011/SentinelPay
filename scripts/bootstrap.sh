...
log "Applying observability stack (Prometheus, Alertmanager, Grafana, Jaeger, Elasticsearch, Promtail)..."
kubectl apply -f "$REPO_ROOT/k8s/observability/prometheus.yaml"
kubectl apply -f "$REPO_ROOT/k8s/observability/alertmanager.yaml"
